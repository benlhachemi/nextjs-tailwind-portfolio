...
export default function Navbar() {
  return (
    <nav className="flex justify-between z-50 relative">
      <h1 className="text-2xl cursor-pointer font-black italic text-transparent bg-clip-text bg-gradient-to-bl from-green-400 to-blue-400">
        Website.dev
      </h1>
