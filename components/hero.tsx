...
export default function Hero() {
  return (
    <div className="xl:text-5xl 2xl:text-6xl font-light w-4/6 mx-auto text-center leading-relaxed flex relative z-50 gap-4 items-center flex-wrap justify-center">
